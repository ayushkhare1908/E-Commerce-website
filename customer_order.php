	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			...
			<ul class="nav navbar-nav">
				...
				<li><a href="index.php"><span class="glyphicon glyphicon-modal-window"></span><b>Product</b></a></li>
			</ul>
		</div>
	</div>
	<p><br/></p>
							...
							if (mysqli_num_rows($query) > 0) {
								while ($row=mysqli_fetch_array($query)) {
									?>
										<div class="row">
											<div class="col-md-6">
												<img style="float:right;" src="product_images/<?php echo $row['product_image']; ?>" class="img-responsive"/>
											</div>
											<div class="col-md-6">
												<table>
